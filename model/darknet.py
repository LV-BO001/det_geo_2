...
class ConvBatchNormReLU_3d(nn.Sequential):
    def __init__(
        self,
        in_channels,
        out_channels,
        ...
        super(ConvBatchNormReLU_3d, self).__init__()
        self.add_module(
            "conv",
            nn.Conv3d(
                in_channels=in_channels,
    ...
    def forward(self, x):
        return super(ConvBatchNormReLU_3d, self).forward(x)
